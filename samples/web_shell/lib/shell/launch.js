...
var launchHterm = function(fsm) {
  ...
  return fsm.createExecuteContext(
    ...
    .then(function (/** ExecuteContext */cx) {
      ...
      delay(100,
          // 'mkstream --type extension --src lfbhahfblgmngkkgbgbccedhhnkkhknb html5:/bar3.str').then(function () {return delay(100,
          'mount.stream html5:/bar3.str').then(function () {return delay(100,

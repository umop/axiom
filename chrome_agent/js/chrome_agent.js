...
export var chromeAgent = {};
export default chromeAgent;

/**
 * @constructor
 */
chromeAgent.ErrorSendingRequest = function(message) {
 ...
 * @constructor
 */
chromeAgent.ErrorExecutingRequest = function(message) {
  this.message = message;
};

chromeAgent.AGENT_APP_ID_ = 'lfbhahfblgmngkkgbgbccedhhnkkhknb';
chromeAgent.AGENT_INSTALL_URL_ =
    'https://chrome.google.com/webstore/detail/' +
    chromeAgent.AGENT_APP_ID_;
 ...
 * @return {void}
 */
chromeAgent.installAgent = function() {
  window.open(chromeAgent.AGENT_INSTALL_URL_);
};
 ...
 * @return {void}
 */
chromeAgent.openApiOnlineDoc = function(api) {
 ...
 */
chromeAgent.callApi = function(api, args, options) {
 ...
 */
chromeAgent.executeScriptInTabs = function(code, tabIds, options) {
 ...
 * @return {!Promise<Object<string, *>>}
 */
chromeAgent.insertCssIntoTabs = function(css, tabIds, options) {
 ...
 * @return {!Promise<*>}
 */
chromeAgent.executeScriptInTab_ = function(tabId, code, options) {
 ...
 * @return {!Promise<*>}
 */
chromeAgent.insertCssIntoTab_ = function(tabId, css, options) {
  var details = {
    code: css,
    allFrames: options.allFrames || false,
    runAt: options.runAt || 'document_idle'
 ...
 * @return {!Promise<Object<string, *>>}
 */
chromeAgent.applyActionToTabs_ = function(tabIds, action, args) {
 ...
 */
chromeAgent.normalizeTabIds_ = function(tabIds) {
 ...
 */
chromeAgent.getAllTabIds_ = function(thisWindowOnly) {
  return new Promise(function(resolve, reject) {
